...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <form method="POST" action="/updatestudent">
        @csrf
        <input class="form-control" type="text" name="title" placeholder="Title" required="required" value="{{ $c->Title}}"><br>
        <input type="hidden" name="id" value="{{ $c->EmployeeID }}" >
        <input class="form-control" type="text" name="fname" placeholder="First Name" required="required" value="{{ $c->FirstName}}"><br>
        <input class="form-control" type="text" name="lname" placeholder="Last Name" required="required" value="{{ $c->LastName}}"><br>
        <input class="form-control" type="text" name="eid" placeholder="Employee ID" required="required" value="{{ $c->EmployeeID }}"><br>
        <input class="form-control" type="text" name="gender" placeholder="Gender" required="required" value="{{ $c->Gender}}"><br>
        <input class="form-control" type="text" name="dob" placeholder="DOB" required="required" value="{{ $c->DateOfBirth}}"><br>
        <input class="form-control" type="text" name="designation" placeholder="Designation" required="required" value="{{ $c->Designation}}"><br>
        <input class="form-control" type="text" name="arole" placeholder="Admin Role" required="required" value="{{ $c->AdminRole}}"><br>
        <input class="form-control" type="text" name="linkedin" placeholder="LinkedIn" required="required" value="{{ $c->LinkedIn}}"><br>
        <input class="form-control" type="text" name="cno" placeholder="Contact Number" required="required" value="{{ $c->ContactNumber}}"><br>
        <input class="form-control" type="text" name="ow" placeholder="Official Website" required="required" value="{{ $c->OfficialWebsite}}"><br>
        <input class="form-control" type="text" name="ri" placeholder="Research Interests" required="required" value="{{ $c->ResearchInterest}}"><br>
        <input class="form-control" type="text" name="fos" placeholder="Field of Specialization" required="required" value="{{ $c->FieldOfSpecialization}}"><br>
