              ...
              <div class="row">
                <div class="col-12 col-sm-auto mb-3">
                  <div class="mx-auto" style="width: 140px;">
                    ...
                    <a href="#">
                    <img src="https://www.kindpng.com/picc/m/252-2524695_dummy-profile-image-jpg-hd-png-download.png" class="profilep" alt="Photo of 3 cats">
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <form method="POST" action="/updatestudent">
        ...
        <input type="hidden" name="id" value="{{ $c->StudentID}}" >
        <input class="form-control" type="text" name="lname" placeholder="Last Name" required="required" value="{{ $c->LastName}}"><br>
        <input class="form-control" type="text" name="si" placeholder="Student ID" required="required" value="{{ $c->StudentID}}"><br>
        <input class="form-control" type="text" name="g" placeholder="Gender" required="required" value="{{ $c->Gender}}"><br>
        <input class="form-control" type="text" name="dob" placeholder="DOB" required="required" value="{{ $c->DateOfBirth}}"><br>
        <input class="form-control" type="text" name="ha" placeholder="Home Address" required="required" value="{{ $c->HomeAddress}}"><br>
        <input class="form-control" type="text" name="cn" placeholder="Contact Number" required="required" value="{{ $c->ContactNumber}}"><br>
        <input class="form-control" type="text" name="li" placeholder="LinkedIn" required="required" value="{{ $c->LinkedIn}}"><br>
        <input class="form-control" type="text" name="sp" placeholder="Study Programme" required="required" value="{{ $c->StudyProgramme}}"><br>
        <input class="form-control" type="text" name="so" placeholder="Subjects Offered" required="required" value="{{ $c->SubjectsOffered}}"><br>
